...
class SalesBoxModel{
  ...
  @override
  String toString() {
    return 'SalesBoxModel{icon: $icon, moreUrl: $moreUrl, bigCard1: $bigCard1, bigCard2: $bigCard2, smallCard1: $smallCard1, smallCard2: $smallCard2, smallCard3: $smallCard3, smallCard4: $smallCard4}';
  }
