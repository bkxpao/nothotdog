...
class GridNavModel{
  ...
  @override
  String toString() {
    return 'GridNavModel{hotel: $hotel, flight: $flight, travel: $travel}';
  }
...
class GridNavItem{
  ...
  @override
  String toString() {
    return 'GridNavItem{startColor: $startColor, endColor: $endColor, mainItem: $mainItem, item1: $item1, item2: $item2, item3: $item3, item4: $item4}';
  }
